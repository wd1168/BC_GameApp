...
$game_query =
    "SELECT g.Game_ID, g.Name, i.Name AS 'Image', Description, Age, Player_Count, m.Name AS 'Manufacturer' FROM
...
while ($row = $statement2->fetch(PDO::FETCH_ASSOC)) {
    $game = array('Game_ID' => $row['Game_ID'], 'Name' => $row['Name'], 'Image' => $row['Image'], 'Description' => $row['Description'],
